...
$i=0;
foreach($idConstrutor as $perfilUser):
		$pai=$this->_listaPermissoes($perfilUser);	 
		...
		//$pages=array();
			...
			{  
					...
					$permissoes=$this->_listaPermissoes1($perfilUser,$c['id_controle']);
